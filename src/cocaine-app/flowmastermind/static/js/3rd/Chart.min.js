...
window.Chart = function(context, options){
    ...
    var Bar = function(data,config,ctx){
        ...
        function drawScale(){
            ...
            ctx.strokeStyle = config.scaleLineColor;
            ctx.beginPath();
            ctx.moveTo(realwidth()-widestXLabel/2+5,xAxisPosY);
            ctx.lineTo(realwidth()-(widestXLabel/2)-xAxisLength-5,xAxisPosY);
            ctx.stroke();
        ...
        function calculateXAxisSize(){
            ...
            xAxisLength = realwidth() - longestText - widestXLabel;
            ...
            yAxisPosX = realwidth()-widestXLabel/2-xAxisLength;
            xAxisPosY = scaleHeight + config.scaleFontSize/2;               
        }       
        function calculateDrawingSizes(){
            maxSize = height;
            ...
            if (realwidth()/data.labels.length < widestXLabel){
                rotateLabels = 45;
                if (realwidth()/data.labels.length < Math.cos(rotateLabels) * widestXLabel){
                    rotateLabels = 90;
                    maxSize -= widestXLabel; 
                }
                else{
