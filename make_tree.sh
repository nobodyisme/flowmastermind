...
tar cvf $CURDIR/debian/tmp/usr/lib/flowmastermind/cocaine-app/flowmastermind.tar.gz \
    *.py \
    flowmastermind/*.py \
    flowmastermind/templates/*.html \
    flowmastermind/templates/utils/*.html \
    flowmastermind/static
cd $CURDIR
